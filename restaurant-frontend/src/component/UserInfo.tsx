    ...
    return (
        <div className="hs-dropdown relative inline-flex">
            <button
                ...
                className="text-gray-400 bg-black bg-opacity-80  focus:bg-gray-900 hover:bg-gray-900 focus:outline-none font-medium rounded-full text-sm text-center inline-flex items-center"
                type="button"
            >
